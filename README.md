...
| `qa-agent` | Повноцінне QA в живому браузері через `playwright`/`chrome-devtools` MCP — тест-план, проходження сценаріїв, структурований звіт про баги, збереження звіту у MD-файл |
